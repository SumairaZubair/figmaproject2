...
import Button from './landingPages/Button'
 export const Data=[{
   ...
   button2:'LEARN MORE'
    ...
    description:'Use Cottage to set up a menu and decide which items are available on which days. Create different locations for your meal prep company to manage them separately. Offer your customers discount codes with a few clicks.',
    dotImg: require('../commonComp/Assest/dot.png'),
    image: require('../commonComp/Assest/menu.png')
 },{
    id: '3',
    title:'Meal plans are easy to manage',
    description:'Cottage lets your customers buy meals from you one at a time, or buy meal plans from you. When customers sign up for one of your plans, Cottage will keep track of which plan they have and how much of it theyve used. At checkout time, customers will automatically have their plan applied to their purchases.',
    dotImg: require('../commonComp/Assest/dot.png'),
    image: require('../commonComp/Assest/mealPlan.png')
 },{
    id: '4',
    title:'Schedule your menu items',
    description:'Use Cottage whether youre an occasional meal prep company or a multi-location enterprise, you can use schedules to make menu items only available on certain days. Also use schedules to set a deadline for ordering.',
    dotImg: require('../commonComp/Assest/dot.png'),
    image: require('../commonComp/Assest/mealItem.png')
 },{
    id: '5',
    title:'Simplify your order management',
    description:'Cottage processes your customers orders and creates a list of menu items to be prepared, organized by day.',
    dotImg: require('../commonComp/Assest/dot.png'),
